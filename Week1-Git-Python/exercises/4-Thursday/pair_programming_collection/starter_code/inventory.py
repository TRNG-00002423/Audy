...
class Inventory:
    ...
    def add_product(self, product: Product) -> int:
        ...
        self.history.append(f"ADD: {product.name} (ID={product_id})")
        self._next_id += 1
        return product_id
    ...
    def remove_product(self, product_id: int) -> Product:
        ...
        self.history.append(f"REMOVE: {product.name} (ID={product_id})")
        return product
    ...
    def search(self, keyword: str) -> list[Product]:
        ...
        """
        # TODO
        return [p for p in self.products.values() if keyword in p]
    ...
    def in_stock(self) -> list[Product]:
        ...
        """
        # TODO
        return [p for p in self.products.values() if bool(p)]
